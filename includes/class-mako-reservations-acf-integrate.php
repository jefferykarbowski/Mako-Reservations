...
class Mako_Reservations_ACF_Integrate {
	/**
	...
	/**
	 * The modus of ACF: Either "installed" if found as a plugin, "bundled" when used via include ore false if not found
	 *
	 * @since    1.0.0
	...
	public function __construct( $name = false, $version = false ) {
		...
		$this->acf_dir = plugin_dir_path( dirname( __FILE__ ) ) .'vendors/advanced-custom-fields-pro/';
		$this->acf_url = plugin_dir_url( dirname( __FILE__ ) ) .'vendors/advanced-custom-fields-pro/';
		$this->acf_json = plugin_dir_path( dirname( __FILE__ ) ) .'vendors/acf_json/';
