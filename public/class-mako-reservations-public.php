                ...
                jQuery( 'body' ).on( 'thickbox:iframe:loaded', function() {
                    iFrameResize({
                        ...
                        onResize: function(iframe){
                            ...
                            //     marginLeft: '-' + parseInt((displayWidth / 2), 10) + 'px',
                            //     width: displayWidth + 'px',
                            //     height: displayHeight + 'px',
                            //     marginTop: '-' + parseInt((displayHeight / 2), 10) + 'px'
                            // });
                        },
                    }, '#TB_iframeContent');
                    ...
                    if (newWidth < 1024) {
                        ...
                        jQuery("#TB_window").css('margin-left', '-' + parseInt((newWidth / 2), 10) + 'px');
                        jQuery("#TB_window").css('margin', '0');
                        jQuery("#TB_window").css('top', '20px');
                        jQuery("#TB_window").css('left', '50%');
                        jQuery("#TB_window").css('transform', 'translate(-50%, 0)');
                    } else {
                        jQuery("#TB_window").css("width", '1024px!important');
                    }
                });
                (function ($) {
                    ...
                    //     $('#TB_iframeContent').css("width", (newWidth));
