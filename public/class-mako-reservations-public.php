                ...
                jQuery( 'body' ).on( 'thickbox:iframe:loaded', function() {
                    iFrameResize({
                        ...
                        onResized: function(messageData){
                            var displayWidth = messageData.width;
                            var displayHeight = messageData.height;
